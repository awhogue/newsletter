 ...
 * the highest-scoring member of the cluster; its feedSummary is replaced with
 * the unified cluster summary so the downstream summarizer will pass it
 * through without another Claude call. The primary's original title is kept.
 */
